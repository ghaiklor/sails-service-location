...
var SmartyStreetsLocation = require('../../lib/SmartyStreetsLocation');
...
describe('SmartyStreetsLocation', function () {
  it('Should properly export', function () {
    assert.isFunction(SmartyStreetsLocation);
  });

  it('Should properly geocode address', function (done) {
    var location = new SmartyStreetsLocation(PROVIDER_CONFIG);
