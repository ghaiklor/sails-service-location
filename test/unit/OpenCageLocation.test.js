...
var OpenCageLocation = require('../../lib/OpenCageLocation');
...
describe('OpenCageLocation', function () {
  it('Should properly export', function () {
    assert.isFunction(OpenCageLocation);
  });

  it('Should properly geocode address', function (done) {
    var location = new OpenCageLocation(PROVIDER_CONFIG);
