...
var DataScienceToolkitLocation = require('../../lib/DataScienceToolkitLocation');
...
describe('DataScienceToolkitLocation', function () {
  it('Should properly export', function () {
    assert.isFunction(DataScienceToolkitLocation);
  });

  it('Should properly geocode address', function (done) {
    var location = new DataScienceToolkitLocation(PROVIDER_CONFIG);
