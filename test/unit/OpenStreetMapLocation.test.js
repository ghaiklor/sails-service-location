...
var OpenStreetMapLocation = require('../../lib/OpenStreetMapLocation');
var geocode = require('../fixtures/geocode.json');

var PROVIDER_CONFIG = {};

describe('OpenStreetMapLocation', function () {
  it('Should properly export', function () {
    assert.isFunction(OpenStreetMapLocation);
  });

  it('Should properly geocode address', function (done) {
    var location = new OpenStreetMapLocation(PROVIDER_CONFIG);
