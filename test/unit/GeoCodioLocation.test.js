...
var GeoCodioLocation = require('../../lib/GeoCodioLocation');
...
describe('GeoCodioLocation', function () {
  it('Should properly export', function () {
    assert.isFunction(GeoCodioLocation);
  });

  it('Should properly geocode address', function (done) {
    var location = new GeoCodioLocation(PROVIDER_CONFIG);
