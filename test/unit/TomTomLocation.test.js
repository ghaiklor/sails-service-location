...
var TomTomLocation = require('../../lib/TomTomLocation');
...
describe('TomTomLocation', function () {
  it('Should properly export', function () {
    assert.isFunction(TomTomLocation);
  });

  it('Should properly geocode address', function (done) {
    var location = new TomTomLocation(PROVIDER_CONFIG);
